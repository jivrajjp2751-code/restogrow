...
content = content.replace(/<div className="card-header">.*?<h3 className="card-title">.*?Categories.*?<\/div>/s, \<div className="card-header"><h3 className="card-title">Categories</h3><button className="btn btn-sm btn-primary" onClick={openNewCat}><Plus size={12} /> ADD</button></div>\);
